...
/**
 * Servlet implementation class ParcelStatusController
 */
public class ParcelStatusController extends HttpServlet {
		...
		ParcelStatusService parcelStatusService=new ParcelStatusService();
		 ...
		 try {
			...
			rs=parcelStatusService.getParcelStatus(parcelStatus);
		     ...
		     RequestDispatcher rd=request.getRequestDispatcher("/DisplayParcelStatus.jsp");
