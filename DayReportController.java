...
import com.pluto.services.DayReportService;

/**
 * Servlet implementation class DayReportController
 */
public class DayReportController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		DayReportService dayReportService=new DayReportService();
		List<Parcel1> trainReportList=new ArrayList<Parcel1>();
		try {
			 ResultSet rs=null;
			rs=dayReportService.getDayReport();
			...
			getServletContext().getRequestDispatcher("/GetDayReport.jsp").forward(request, response);
